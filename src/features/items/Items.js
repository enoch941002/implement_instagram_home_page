...
const Items = () => {
    const item = ['', 'message', 'new_post', 'explore', 'activity', 'me']
    return item.map((v,k) => {
        let act = '';
        switch (v) {
            case 'message':
                ...
                break;
            case 'new_post':
                act = <svg aria-label="新貼文" className="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
            ...
            case 'explore':
                act = <span>
                    <svg aria-label="尋找用戶" className="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                ...
                break;
            case 'activity':
                act = <svg aria-label="活動動態" className="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                ...
                break;
            case 'me':
                act = <img src={me} alt='我'></img>
                break;
            default:
                act = <a href={`./${v}`}>
                    <svg aria-label="首頁" className="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                        <path d="M22 23h-6.001a1 1 0 01-1-1v-5.455a2.997 2.997 0 10-5.993 0V22a1 1 0 01-1 1H2a1 1 0 01-1-1V11.543a1.002 1.002 0 01.31-.724l10-9.543a1.001 1.001 0 011.38 0l10 9.543a1.002 1.002 0 01.31.724V22a1 1 0 01-1 1z"></path>
                    </svg>
                </a>
        }
        return (
            <div className='items' key={k}>{act}</div>
        )
    })
}
