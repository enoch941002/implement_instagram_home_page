...
import { updateNewsState } from 'features/newsDynamic/newsDynamicSlice'
export const NewsDynamicItems = () => {
    const newDynamicItem = useSelector(state => state.news.newsDynamic)
